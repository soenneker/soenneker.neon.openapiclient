...
{
    /// <summary>
    /// Builds and executes requests for operations under \projects\{projectId}\auth\domains
    /// </summary>
    ...
    public partial class DomainsRequestBuilder : BaseRequestBuilder
    {
        ...
        public DomainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectId}/auth/domains", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Neon.OpenApiClient.Projects.Item.Auth.Domains.DomainsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DomainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectId}/auth/domains", rawUrl)
        {
        }
        /// <summary>
