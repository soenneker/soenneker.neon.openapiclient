...
using System;
namespace Soenneker.Neon.OpenApiClient.Users.Me
{
    /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Neon.OpenApiClient.Models.CurrentUserInfoResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Neon.OpenApiClient.Models.CurrentUserInfoResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Neon.OpenApiClient.Users.Me.MeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Neon.OpenApiClient.Users.Me.MeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Neon.OpenApiClient.Users.Me.MeRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
