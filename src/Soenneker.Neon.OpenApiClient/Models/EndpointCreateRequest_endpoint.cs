...
namespace Soenneker.Neon.OpenApiClient.Models
{
    ...
    public partial class EndpointCreateRequest_endpoint : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The ID of the branch the compute endpoint will be associated with</summary>
...
#nullable restore
        ...
        public string Provisioner { get; set; }
#endif
        /// <summary>The region where the compute endpoint will be created. Only the project&apos;s `region_id` is permitted.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Neon.OpenApiClient.Models.EndpointCreateRequest_endpoint"/> and sets the default values.
        /// </summary>
        public EndpointCreateRequest_endpoint()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Neon.OpenApiClient.Models.EndpointCreateRequest_endpoint"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Neon.OpenApiClient.Models.EndpointCreateRequest_endpoint CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Neon.OpenApiClient.Models.EndpointCreateRequest_endpoint();
        }
        /// <summary>
